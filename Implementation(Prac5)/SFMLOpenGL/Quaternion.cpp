...
MyVector3 Quaternion::Rotate(MyVector3 vectorToRotate, float angle)
{
	...
	return MyVector3(q1.GetX(), q1.GetY(), q1.GetZ());
}

//Function Rotates A Vector About The X Axis By A Given Value
MyVector3 Quaternion::RotateAboutX(MyVector3 vectorToRotate, float angle)
{
...
MyVector3 Quaternion::RotateAboutY(MyVector3 vectorToRotate, float angle)
{
...
MyVector3 Quaternion::RotateAboutZ(MyVector3 vectorToRotate, float angle)
{
